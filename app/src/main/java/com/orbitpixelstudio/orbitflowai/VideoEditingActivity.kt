...
import com.orbitpixelstudio.orbitflowai.utils.performHapticLight
import com.orbitpixelstudio.orbitflowai.utils.performHapticClick
...
import com.orbitpixelstudio.orbitflowai.R
...
import com.orbitpixelstudio.orbitflowai.customviews.CustomVideoSeeker
import com.orbitpixelstudio.orbitflowai.customviews.DraggableTextOverlayView
import com.orbitpixelstudio.orbitflowai.customviews.DraggableImageOverlayView
import com.orbitpixelstudio.orbitflowai.customviews.ImageOverlayView
import com.orbitpixelstudio.orbitflowai.models.EditOperation
import com.orbitpixelstudio.orbitflowai.models.VideoProject
import com.orbitpixelstudio.orbitflowai.models.TextPosition
import com.orbitpixelstudio.orbitflowai.models.id
import kotlinx.coroutines.Job
import com.orbitpixelstudio.orbitflowai.services.FFmpegRenderEngine
import com.orbitpixelstudio.orbitflowai.utils.ErrorCode
import com.orbitpixelstudio.orbitflowai.viewmodels.VideoEditingViewModel
...
class VideoEditingActivity : AppCompatActivity() {
    ...
    private lateinit var timeRulerView: com.orbitpixelstudio.orbitflowai.customviews.TimeRulerView
    ...
    private var textOverlayView: com.orbitpixelstudio.orbitflowai.customviews.TextOverlayView? = null
    private var transitionPreviewOverlayView: com.orbitpixelstudio.orbitflowai.customviews.TransitionPreviewOverlayView? = null
    ...
    private fun setupTextFontSelector(formatContainer: View?) {
        ...
        val allFonts = com.orbitpixelstudio.orbitflowai.utils.FontManager.getAllFonts(this, fontFilePath)
    ...
    private fun showFontManagerBottomSheet(onFontSelected: ((com.orbitpixelstudio.orbitflowai.utils.FontItem) -> Unit)? = null) {
                    ...
                    onDelete = { fontItem ->
                        MaterialAlertDialogBuilder(this)
                            ...
                            .setPositiveButton("Delete") { _, _ ->
                                if (com.orbitpixelstudio.orbitflowai.utils.FontManager.deleteCustomFont(this, fontItem.path)) {
    ...
    private class FontManagerAdapter(
        private val fonts: List<com.orbitpixelstudio.orbitflowai.utils.FontItem>,
        private val selectedPath: String?,
        private val onSelect: (com.orbitpixelstudio.orbitflowai.utils.FontItem) -> Unit,
        private val onDelete: (com.orbitpixelstudio.orbitflowai.utils.FontItem) -> Unit
    ...
    private var videoMaskOverlayView: com.orbitpixelstudio.orbitflowai.customviews.VideoMaskOverlayView? = null
    private var mainVideoMaskContainer: com.orbitpixelstudio.orbitflowai.customviews.MaskedFrameLayout? = null
    private var initialCropOperation: com.orbitpixelstudio.orbitflowai.models.EditOperation.Crop? = null
    ...
    private val saveProjectLauncher = registerForActivityResult(
        ...
        if (uri != null) {
            try {
                val project = viewModel.project.value
                if (project != null) {
                    val recipe = com.orbitpixelstudio.orbitflowai.models.EditRecipe.fromVideoProject(project.sourceName, project)
                    val json = com.orbitpixelstudio.orbitflowai.utils.ProjectSerializer.serialize(recipe)
    ...
    private var activeFontSelectionCallback: ((com.orbitpixelstudio.orbitflowai.utils.FontItem) -> Unit)? = null

    private val importFontLauncher = registerForActivityResult(
        androidx.activity.result.contract.ActivityResultContracts.OpenDocument()
    ) { uri: Uri? ->
        if (uri != null) {
            val importedFont = com.orbitpixelstudio.orbitflowai.utils.FontManager.importFontFromUri(this, uri)
    ...
    private fun showProErrorDialog(errorCode: ErrorCode, technicalLog: String) {
        ...
        MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton("Report on GitHub") { _, _ ->
                val githubUrl = "https://orbitpixelstudio.com/report-a-bug?title=" +
    ...
    private fun initializeViews() {
        ...
        playerContainer.viewTreeObserver.addOnGlobalLayoutListener(object : android.view.ViewTreeObserver.OnGlobalLayoutListener {
            override fun onGlobalLayout() {
                val cropOps = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Crop>()
        ...
        textOverlayView = try {
            findViewById<com.orbitpixelstudio.orbitflowai.customviews.TextOverlayView>(R.id.textOverlayView)?.also { overlay ->
        ...
        videoMaskOverlayView = try {
            findViewById<com.orbitpixelstudio.orbitflowai.customviews.VideoMaskOverlayView>(R.id.videoMaskOverlayView)?.also { overlay ->
        ...
        cropOverlayView = try {
            findViewById<com.orbitpixelstudio.orbitflowai.customviews.CropOverlayView>(R.id.cropOverlayView)?.also { overlay ->
                overlay.onCropBoundsChanged = { x, y, w, h ->
                    val existing = viewModel.project.value?.operations
                        ?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Crop>()
                        ?.lastOrNull()
        ...
        audioEditingToolbar = try {
            findViewById<View>(R.id.audioEditingToolbar)?.also { toolbar ->
                ...
                toolbar.findViewById<ImageButton>(R.id.btnAudioBeats)?.setBounceClickListener {
                    ...
                    val op = project.operations.find { it is com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio && it.id == id } as? com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio ?: return@setBounceClickListener
                    ...
                    com.orbitpixelstudio.orbitflowai.utils.AudioAnalyzer.detectBeats(this@VideoEditingActivity, op.audioUri) { beats ->
                        runOnUiThread {
                            if (beats.isNotEmpty()) {
                ...
                volumeSlider?.addOnChangeListener { _, value, _ ->
                    ...
                    viewModel.selectedOperationId.value?.let { id ->
                        ...
                        val op = project.operations.find { it is com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio && it.id == id } as? com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio
                        if (op != null) {
                ...
                val trimTrack = toolbar.findViewById<com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView>(R.id.audioTrimTrack)
        ...
        subtitlesEditingToolbar = try {
            findViewById<View>(R.id.subtitlesEditingToolbar)?.also { toolbar ->
                ...
                toolbar.findViewById<View>(R.id.btnGenerateAiCaptions)?.setBounceClickListener {
                    showAiCaptionGeneratorDialog()
                }
    ...
    private fun saveBitmapToGallery(bitmap: android.graphics.Bitmap) {
        val filename = "OrbitFlowAI_Frame_${System.currentTimeMillis()}.png"
        var fos: java.io.OutputStream? = null
        var imageUri: Uri? = null
        try {
            val sharedPreferences = getSharedPreferences("orbitflowai_prefs", Context.MODE_PRIVATE)
            ...
            if (fos == null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    val contentValues = android.content.ContentValues().apply {
                        ...
                        put(android.provider.MediaStore.MediaColumns.RELATIVE_PATH, android.os.Environment.DIRECTORY_PICTURES + "/OrbitFlow AI")
                    }
                    ...
                    val directory = java.io.File(imagesDir, "OrbitFlow AI")
    ...
    private fun showAiCaptionGeneratorDialog() {
        ...
        val descriptionInput = android.widget.EditText(this).apply {
            hint = getString(R.string.str_ai_caption_hint)
            minLines = 3
        ...
        inputLayout.addView(descriptionInput)

        MaterialAlertDialogBuilder(this)
            .setTitle(R.string.str_ai_caption_generator)
            .setMessage(R.string.str_ai_caption_generator_desc)
            .setView(inputLayout)
            .setPositiveButton(R.string.str_generate) { _, _ ->
                val description = descriptionInput.text?.toString()?.trim().orEmpty()
                generateAiCaptions(description)
            }
            .setNegativeButton(R.string.cancel, null)
            .show()
    }

    private fun generateAiCaptions(description: String) {
        val durationMs = try {
        ...
        val durationSeconds = (if (durationMs > 0) durationMs / 1000.0 else 30.0).coerceAtLeast(3.0)

        val topic = description.ifBlank { "a short, engaging social media video" }
        val prompt = """
            Write timed on-screen captions in strict SRT format for a video about: "$topic"
            The video is approximately ${"%.0f".format(durationSeconds)} seconds long.
            Rules:
            - Output ONLY valid SRT — sequence numbers, timestamps (00:00:00,000 --> 00:00:00,000), and short caption lines.
            - Cover the full duration, with each caption lasting 2-4 seconds.
            - Keep each caption under 8 words, punchy and easy to read at a glance.
            - Do not include any explanation, markdown, or text outside the SRT itself.
        """.trimIndent()

        showLoading(getString(R.string.str_generating_captions))
        lifecycleScope.launch {
            ...
            when (result) {
                is com.orbitpixelstudio.orbitflowai.utils.ai.AiResult.Success -> {
                    val srtContent = result.text.trim().removePrefix("```srt").removePrefix("```").removeSuffix("```").trim()
                    val cues = withContext(Dispatchers.IO) {
                        try {
                            com.orbitpixelstudio.orbitflowai.utils.SubtitleParser.parse(srtContent)
                        } catch (e: Exception) {
                            emptyList()
                        }
                    }
                    ...
                    val tempFile = withContext(Dispatchers.IO) {
                        try {
                            val file = java.io.File(cacheDir, "ai_captions_${System.currentTimeMillis()}.srt")
                    ...
                    val tempUri = tempFile?.let { Uri.fromFile(it) } ?: Uri.EMPTY
                    ...
                    viewModel.addOperation(
                        EditOperation.AddSubtitles(
                            ...
                            fileName = "ai_captions.srt",
                            cues = cues
                        )
                    )
                    Toast.makeText(
                        this@VideoEditingActivity,
                        getString(R.string.str_ai_captions_generated, cues.size),
                        Toast.LENGTH_SHORT
                    ).show()
                    updateSubtitlesUi()
    ...
    /**
     * Orbit AI assistant: a lightweight Q&A dialog. Not a multi-turn chat yet —
     * each question is answered fresh with light context about the current
     * project (duration, how many edits are queued) so answers stay relevant
     * to "this video" rather than being generic.
     */
    private fun showOrbitAiAssistantDialog() {
        if (!com.orbitpixelstudio.orbitflowai.utils.ai.AiTextGenerator.isConfigured(this)) {
            Toast.makeText(this, R.string.str_no_api_key_set, Toast.LENGTH_LONG).show()
            return
        }
        ...
        val dialog = MaterialAlertDialogBuilder(this)
            ...
            .setMessage(R.string.str_orbit_ai_desc)
            .setView(container)
            .setPositiveButton(R.string.str_ask, null)
            .setNegativeButton(R.string.cancel, null)
            .create()
    ...
    private fun openImagePicker() {
        val picker = com.orbitpixelstudio.orbitflowai.customviews.MediaPickerBottomSheet().apply {
            initialMediaType = com.orbitpixelstudio.orbitflowai.customviews.MediaPickerBottomSheet.MediaType.IMAGE
    ...
    private fun freezeFrameAtCurrentPosition() {
        ...
        lifecycleScope.launch {
            val resultUri = withContext(Dispatchers.IO) {
                ...
                if (renderResult is com.orbitpixelstudio.orbitflowai.services.FFmpegRenderEngine.RenderResult.Success) {
            ...
            if (resultUri != null) {
                val freezeFrameItem = com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem(resultUri, 3000L)
                val newItems = mutableListOf<com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem>()
    ...
    private fun enterAudioEditingMode(op: com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio) {
        closeActiveEditingModes()
        selectedVideoIndex = null
    ...
    private fun showFadeDialog(op: com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio) {
        val bottomSheet = BottomSheetDialog(this)
    ...
    private fun showSpeedEditingToolbar(index: Int, item: com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem) {
        closeActiveEditingModes()
        ...
        if (speed == 1.0f) {
            ...
            if (item.isReversed) {
                lifecycleScope.launch {
                    ...
                    hideLoading()
                    if (result is com.orbitpixelstudio.orbitflowai.services.FFmpegRenderEngine.RenderResult.Success) {
        ...
        lifecycleScope.launch {
            ...
            if (result is com.orbitpixelstudio.orbitflowai.services.FFmpegRenderEngine.RenderResult.Success) {
                if (item.isReversed) {
                    ...
                    if (reverseResult is com.orbitpixelstudio.orbitflowai.services.FFmpegRenderEngine.RenderResult.Success) {
    ...
    private fun reverseVideoSegment(index: Int, item: com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem) {
        if (item.isReversed) {
            // Un-reverse the clip
            if (index == 0) {
                if (item.speed == 1.0f) {
    ...
    private fun regenerateSpeedProxyForUnreverse(index: Int, item: com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem) {
        lifecycleScope.launch {
    ...
    private fun updateVideoSegment(index: Int, newItem: com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem) {
        val project = viewModel.project.value ?: return
        val currentMergeOp = project.operations.find { it is com.orbitpixelstudio.orbitflowai.models.EditOperation.Merge } as? com.orbitpixelstudio.orbitflowai.models.EditOperation.Merge ?: return
    ...
    private fun extractAudioFromSegment(index: Int, item: com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem) {
        lifecycleScope.launch {
            showLoading("Extracting audio...")
            val ffmpegEngine = com.orbitpixelstudio.orbitflowai.services.FFmpegRenderEngine(this@VideoEditingActivity)
            ...
            if (result is com.orbitpixelstudio.orbitflowai.services.FFmpegRenderEngine.RenderResult.Success) {
                ...
                viewModel.addOperation(
                    com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio(
                        audioUri = tempUri,
            ...
            } else if (result is com.orbitpixelstudio.orbitflowai.services.FFmpegRenderEngine.RenderResult.Failure) {
            ...
            val mergeItems = withContext(Dispatchers.IO) {
                selectedVideoUris.mapNotNull { uri ->
                    ...
                    if (tempFile != null) {
                        ...
                        com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem(tempUri, duration)
                    } else null
                }
            }
            ...
            data?.data?.let { srtUri ->
                lifecycleScope.launch {
                    ...
                    if (tempFile != null) {
                        ...
                        val cues = withContext(Dispatchers.IO) {
                            try {
                                com.orbitpixelstudio.orbitflowai.utils.SubtitleParser.parse(content)
                            } catch (e: Exception) {
                                emptyList()
                            }
                        }
    ...
    private fun audioAction() {
        val picker = com.orbitpixelstudio.orbitflowai.customviews.MediaPickerBottomSheet().apply {
            initialMediaType = com.orbitpixelstudio.orbitflowai.customviews.MediaPickerBottomSheet.MediaType.AUDIO
            showCategoryTabs = false
            onMediaSelectedListener = { uri ->
        ...
        exportJob = kotlinx.coroutines.CoroutineScope(kotlinx.coroutines.Dispatchers.Main + kotlinx.coroutines.Job()).launch {
            ...
            try {
                ...
                withContext(kotlinx.coroutines.Dispatchers.IO) {
                    ...
                    val ext = if (isAudioOnly) ".mp3" else ".mp4"
                    val prefix = if (isAudioOnly) "OrbitFlowAI_Audio_" else "OrbitFlowAI_"
                    ...
                    val outputStream = if (customFileUri != null) {
                        ...
                        val outputDir = File(defaultDir, "OrbitFlow AI")
                    ...
                    withContext(kotlinx.coroutines.Dispatchers.Main) {
                        ...
                        val displayPath = if (customFileUri != null) {
                            ...
                            outputFile?.absolutePath ?: "Downloads/OrbitFlow AI"
                        }
                        Toast.makeText(
                            this@VideoEditingActivity,
    ...
    private fun updateExportDirectoryUi(titleView: TextView, pathView: TextView) {
        ...
        if (customUriString != null) {
            ...
            titleView.text = "OrbitFlow AI (Default)"
            pathView.text = if (isAudioOnly) "Music/OrbitFlow AI" else "Movies/OrbitFlow AI"
        }
    }
        ...
        if (projectUri != null) {
            ...
            try {
                contentResolver.openInputStream(projectUri)?.use { inputStream ->
                    ...
                    val editRecipe = com.orbitpixelstudio.orbitflowai.utils.ProjectSerializer.deserialize(json)
    ...
    private fun getSequenceItems(): List<com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem> {
        val items = mutableListOf<com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem>()
        ...
        val trimOp = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Trim>()?.lastOrNull()
        val sTrimStart = trimOp?.startMs ?: 0L
        val sTrimEnd = trimOp?.endMs ?: sourceDuration
        val speedOp = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.SpeedMain>()?.lastOrNull()
        val speed = speedOp?.speed ?: 1.0f
        val reverseOp = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.ReverseMain>()?.lastOrNull()
        val isReversed = reverseOp?.isReversed ?: false
        val proxyUri = reverseOp?.proxyUri ?: speedOp?.proxyUri
        val mirrorOp = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.MirrorMain>()?.lastOrNull()
        val isMirrored = mirrorOp?.isMirrored ?: false
        val maskMainOp = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskMain>()?.lastOrNull()
        val maskConfig = maskMainOp?.maskConfig ?: com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig()

        items.add(com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem(
            uri = sourceUri,
        ...
        val mergeOp = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Merge>()?.firstOrNull()
        if (mergeOp != null) {
    ...
    private var lastAppliedAdjust: com.orbitpixelstudio.orbitflowai.models.EditOperation.Adjust? = null

    private fun applyColorFilterToPlayer(filterName: String) {
        val idx = selectedVideoIndex ?: 0
        val activeAdjust = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Adjust>()
            ?.find { it.index == idx }
    ...
    private fun applyColorFilterAndAdjustToPlayer(
        filterName: String,
        adjust: com.orbitpixelstudio.orbitflowai.models.EditOperation.Adjust?
    ) {
    ...
    private fun syncUiWithPlayer() {
        ...
        if (totalDuration > 0) {
            ...
            val activeFilterName = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.ColorFilter>()
            ...
            val isMirrored = if (activeClipIndex == 0) {
                viewModel.project.value?.operations?.any { it is com.orbitpixelstudio.orbitflowai.models.EditOperation.MirrorMain && it.isMirrored } == true
            } else {
                viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Merge>()
            ...
            val transitionOps = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Transition>() ?: emptyList()
    ...
    private fun performRenderTracks(project: VideoProject) {
        ...
        val exoAudioOps = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio>() ?: emptyList()
        ...
        for (i in 0 until sortedBoundaries.size - 1) {
            ...
            for ((index, item) in sequenceItems.withIndex()) {
                ...
                if (chunkStartMs >= vStart && chunkEndMs <= vEnd) {
                    ...
                    val isClipMuted = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.MuteClip>()
        ...
        sequenceItems.forEachIndexed { index, item ->
            ...
            val trackTrimView = segmentView.findViewById<com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView>(R.id.segmentTrimTrack)
            ...
            if (index > 0) {
                ...
                val transitionOp = project.operations.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Transition>().find { it.index == index - 1 }
        ...
        if (overlayOps.isNotEmpty()) {
            ...
            for (op in overlayOps.reversed()) {
                ...
                val trackView = com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView(this).apply {
                ...
                val trackView = com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView(this).apply {
                    ...
                    onTrimChanged = { start, end, target ->
                        val oldOp = viewModel.project.value?.operations?.find { 
                            (it as? com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio)?.id == op.id 
                        } as? com.orbitpixelstudio.orbitflowai.models.EditOperation.AddBackgroundAudio
                        if (oldOp != null) {
                            var newInternalStart = oldOp.internalStartMs
                            if (target == com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView.DragTarget.LEFT) {
        ...
        for (op in project.operations) {
            ...
            if (op is com.orbitpixelstudio.orbitflowai.models.EditOperation.AddText) {
            ...
            } else if (op is com.orbitpixelstudio.orbitflowai.models.EditOperation.AddImageOverlay) {
                keyframes.addAll(op.positionKeyframes.map { it.timeMs })
                keyframes.addAll(op.opacityKeyframes.map { it.timeMs })
            ...
            if (distinctKeyframes.isNotEmpty()) {
                ...
                val trackView = com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView(this).apply {
                    ...
                    onTrackClicked = {
                        viewModel.selectOperation(op.id)
                        enterKeyframeEditingMode(op is com.orbitpixelstudio.orbitflowai.models.EditOperation.AddText)
                    }
                }
    ...
    private fun showVideoSegmentTrimDialog(index: Int, item: com.orbitpixelstudio.orbitflowai.models.EditOperation.MergeItem) {
        if (isShowingPreview) dismissPreview()
        ...
        val trimTrackView = view.findViewById<com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView>(R.id.trimTrackView)
    ...
    private fun updateVideoMuteButtonState(toolbar: View, index: Int) {
        val isMuted = viewModel.project.value?.operations?.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.MuteClip>()
            ?.find { it.index == index }?.isMuted ?: false
    ...
    private fun showColorFilterSelectionDialog(clipIndex: Int) {
        ...
        val project = viewModel.project.value ?: return
        val existingOp = project.operations.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.ColorFilter>().find { it.index == clipIndex }
    ...
    private fun showTransitionDialog(transitionIndex: Int) {
        ...
        fun applyTransitionToIndex(idx: Int, transType: String, durationMs: Long = activeDurationMs) {
            ...
            val existing = proj.operations.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Transition>().find { it.index == idx }
            if (transType == "none") {
                if (existing != null) {
    ...
    private fun saveVideoToGallery(videoFile: File): Uri? {
        ...
        // Fallback or Default to Movies/OrbitFlow AI
        return try {
            val contentValues = android.content.ContentValues().apply {
                put(MediaStore.MediaColumns.DISPLAY_NAME, "${prefix}${System.currentTimeMillis()}$ext")
                put(MediaStore.MediaColumns.MIME_TYPE, mimeType)
                if (isAudioOnly) {
                    put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_MUSIC + "/OrbitFlow AI")
                } else {
                    put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_MOVIES + "/OrbitFlow AI")
                }
            }
    ...
    private fun updateActiveBoundaries(activeStart: Long, activeEnd: Long) {
        for (i in 0 until textTrackContainer.childCount) {
            val track = textTrackContainer.getChildAt(i) as? com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView
            track?.let {
        ...
        for (i in 0 until imageTrackContainer.childCount) {
            val track = imageTrackContainer.getChildAt(i) as? com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView
            track?.let {
                it.activeStartMs = activeStart
                it.activeEndMs = activeEnd
                it.invalidate()
        ...
        for (i in 0 until audioTrackContainer.childCount) {
            val track = audioTrackContainer.getChildAt(i) as? com.orbitpixelstudio.orbitflowai.customviews.TrackTrimView
            track?.let {
                it.activeStartMs = activeStart
                it.activeEndMs = activeEnd
                it.invalidate()
    ...
    private fun showAdjustSelectionDialog(clipIndex: Int) {
        ...
        val project = viewModel.project.value ?: return
        val existingOp = project.operations.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.Adjust>().find { it.index == clipIndex }
        
        var localAdjust = existingOp ?: com.orbitpixelstudio.orbitflowai.models.EditOperation.Adjust(index = clipIndex)
        ...
        val activeFilterName = project.operations.filterIsInstance<com.orbitpixelstudio.orbitflowai.models.EditOperation.ColorFilter>()
        ...
        for ((id, displayName) in options) {
            ...
            itemView.setOnClickListener {
                if (id == "reset") {
                    localAdjust = com.orbitpixelstudio.orbitflowai.models.EditOperation.Adjust(index = clipIndex)
                    viewModel.setAdjust(
                        index = clipIndex,
                        brightness = 0,
                        contrast = 0,
    ...
    private fun showChromaKeyDialog() {
        ...
        val hsvPicker = view.findViewById<com.orbitpixelstudio.orbitflowai.customviews.HSVColorPickerView>(R.id.hsvChromaColorPicker)
    ...
    private fun showCustomColorPicker(initialHex: String, onColorPicked: (String) -> Unit) {
        ...
        val hsvPicker = view.findViewById<com.orbitpixelstudio.orbitflowai.customviews.HSVColorPickerView>(R.id.hsvColorPicker)
    ...
    private fun interpolateKeyframes(
        keyframes: List<com.orbitpixelstudio.orbitflowai.models.EditOperation.KeyframePoint>,
        timeMs: Long,
        defaultValue: Float
    ): Float {
    ...
    private fun showMaskBottomSheet() {
        ...
        var currentMask = if (isMainVideo) {
            ...
            val items = getSequenceItems()
            if (idx >= 0 && idx < items.size) items[idx].maskConfig else com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig()
        } else {
            draggableImageOverlay?.maskConfig ?: com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig()
        }
        ...
        fun highlightShape(selectedShape: com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape) {
            val shapeMap = mapOf(
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.NONE to Pair(bgNone, imgNone),
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.SPLIT to Pair(bgSplit, imgSplit),
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.SHUTTER to Pair(bgShutter, imgShutter),
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.ELLIPSE to Pair(bgEllipse, imgEllipse),
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.RECTANGLE to Pair(bgRectangle, imgRectangle),
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.HEART to Pair(bgHeart, imgHeart),
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.STAR to Pair(bgStar, imgStar)
            )
        ...
        if (isMainVideo) {
            ...
            draggableImageOverlay?.isMaskEditingMode = currentMask.shape != com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.NONE
        }

        fun applyMaskToView(newMask: com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig) {
            currentMask = newMask
            if (isMainVideo) {
                ...
                draggableImageOverlay?.isMaskEditingMode = newMask.shape != com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.NONE
                draggableImageOverlay?.invalidate()
                draggableImageOverlay?.onMaskChanged?.invoke(newMask)
            }
        }

        fun updateMaskShape(shape: com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape) {
            val newMask = currentMask.copy(shape = shape)
            applyMaskToView(newMask)
            highlightShape(shape)
        }

        btnNone?.setOnClickListener { updateMaskShape(com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.NONE) }
        btnSplit?.setOnClickListener { updateMaskShape(com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.SPLIT) }
        btnShutter?.setOnClickListener { updateMaskShape(com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.SHUTTER) }
        btnEllipse?.setOnClickListener { updateMaskShape(com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.ELLIPSE) }
        btnRectangle?.setOnClickListener { updateMaskShape(com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.RECTANGLE) }
        btnHeart?.setOnClickListener { updateMaskShape(com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.HEART) }
        btnStar?.setOnClickListener { updateMaskShape(com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.STAR) }
        ...
        btnResetMask?.setOnClickListener {
            val resetMask = com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig()
            ...
            updateMaskShape(com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.NONE)
        }
