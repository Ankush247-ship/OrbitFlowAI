package com.orbitpixelstudio.orbitflowai.customviews
...
class DraggableImageOverlayView @JvmOverloads constructor(
    ...
    // ── Public callbacks ──────────────────────────────────────────────────────
    var onImageCommitted: ((uri: Uri, relativeX: Float, relativeY: Float, relativeWidth: Float, relativeHeight: Float, rotationAngle: Float, opacity: Float, isMirrored: Boolean, maskConfig: com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig) -> Unit)? = null
    var onPositionChanged: ((relativeX: Float, relativeY: Float) -> Unit)? = null
    var onMaskChanged: ((com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig) -> Unit)? = null
    ...
    var maskConfig = com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig()
    ...
    fun activate(uri: Uri, aspect: Float = 1.0f) {
        ...
        maskConfig = com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskConfig()
        post {
            updateImageViewSizeAndPosition()
        }
    }

    fun activateForEdit(op: com.orbitpixelstudio.orbitflowai.models.EditOperation.AddImageOverlay) {
        isEditingActive = true
    ...
    override fun dispatchDraw(canvas: Canvas) {
        val hasMask = maskConfig.shape != com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.NONE
        if (hasMask && isEditingActive && imageUri != null) {
            ...
            when (maskConfig.shape) {
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.RECTANGLE -> {
                    path.addRect(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.ELLIPSE -> {
                    path.addOval(cx - mw/2, cy - mh/2, cx + mw/2, cy + mh/2, android.graphics.Path.Direction.CW)
                }
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.SPLIT -> {
                ...
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.SHUTTER -> {
                ...
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.HEART -> {
                    createHeartPath(path, cx, cy, mw, mh)
                }
                com.orbitpixelstudio.orbitflowai.models.EditOperation.MaskShape.STAR -> {
